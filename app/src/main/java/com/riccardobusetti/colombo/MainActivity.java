...
import com.riccardobusetti.colombo.util.ColorSwitchAnimation;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void handleIncognito() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            int colorFrom = ContextCompat.getColor(this, !isIncognito ? R.color.colorPrimaryDarkIncognito : R.color.colorPrimaryDark);
            int colorTo = ContextCompat.getColor(this, isIncognito ? R.color.colorPrimaryDarkIncognito : R.color.colorPrimaryDark);
            ColorSwitchAnimation.switchColor(getWindow(), colorFrom, colorTo);

            // Background color switch
            colorFrom = ContextCompat.getColor(this, !isIncognito ? R.color.colorPrimaryIncognito : R.color.colorPrimary);
            colorTo = ContextCompat.getColor(this, isIncognito ? R.color.colorPrimaryIncognito : R.color.colorPrimary);
            ColorSwitchAnimation.switchColor(findViewById(R.id.static_background), colorFrom, colorTo);

            swipeRefreshLayout.setColorSchemeColors(
                    ContextCompat.getColor(this, isIncognito ? R.color.swipeRefreshIncognito : R.color.swipeRefresh)
            );
        }
    }
